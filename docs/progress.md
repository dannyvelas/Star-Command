...
- [ ] Add OVN support
- [ ] Add VLAN segmentation (A management VLAN for SSH access to hosts, a separate VLAN for OVN overlay traffic between hosts, A VLAN isolating your homelab network from your regular home network)
